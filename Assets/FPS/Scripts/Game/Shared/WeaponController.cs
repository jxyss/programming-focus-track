...
namespace Unity.FPS.Game
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        void UpdateAmmo()
        {
            ...
            {
                if (AutomaticReload && m_LastTimeShot + AmmoReloadDelay * 1 / SkillSocket.Instance.globalFireRate * 1/SkillSocket.Instance.hGFireRate < Time.time && m_CurrentAmmo < MaxAmmo && !IsCharging)
                {

                    m_CurrentAmmo += AmmoReloadRate * Time.deltaTime * SkillSocket.Instance.globalFireRate * SkillSocket.Instance.hGFireRate;
            ...
            {
                if (AutomaticReload && m_LastTimeShot + AmmoReloadDelay * 1 / SkillSocket.Instance.globalFireRate * 1/SkillSocket.Instance.lFireRate < Time.time && m_CurrentAmmo < MaxAmmo && !IsCharging)
                {
                    m_CurrentAmmo += AmmoReloadRate * Time.deltaTime * SkillSocket.Instance.globalFireRate * SkillSocket.Instance.lFireRate;
                    m_CurrentAmmo = Mathf.Clamp(m_CurrentAmmo, 0, MaxAmmo);
            ...
            {
                if (AutomaticReload && m_LastTimeShot + AmmoReloadDelay * 1 / SkillSocket.Instance.globalFireRate * 1 / SkillSocket.Instance.sGFireRate < Time.time && m_CurrentAmmo < MaxAmmo && !IsCharging)
                {
                    m_CurrentAmmo += AmmoReloadRate * Time.deltaTime * SkillSocket.Instance.globalFireRate * SkillSocket.Instance.sGFireRate;
                    m_CurrentAmmo = Mathf.Clamp(m_CurrentAmmo, 0, MaxAmmo);
            ...
            {
                if (AutomaticReload && m_LastTimeShot + AmmoReloadDelay * 1 / SkillSocket.Instance.globalFireRate < Time.time && m_CurrentAmmo < MaxAmmo && !IsCharging)
                {
                    m_CurrentAmmo += AmmoReloadRate * Time.deltaTime * SkillSocket.Instance.globalFireRate;
                    m_CurrentAmmo = Mathf.Clamp(m_CurrentAmmo, 0, MaxAmmo);
        ...
        void UpdateCharge()
        {
            if (IsCharging)
            {
                if (CurrentCharge < 1f)
                {
                    ...
                    {
                        chargeAdded = (1f / MaxChargeDuration) * Time.deltaTime * SkillSocket.Instance.globalFireRate * SkillSocket.Instance.lFireRate;
                    }
        ...
        bool TryShoot()
        {
            ...
            {
                if (m_CurrentAmmo >= 1f
                && m_LastTimeShot + DelayBetweenShots * 1 / SkillSocket.Instance.globalFireRate * 1/SkillSocket.Instance.hGFireRate < Time.time)
                {
                    HandleShoot();
                    m_CurrentAmmo -= 1f;
            ...
            {
                if (m_CurrentAmmo >= 1f
                && m_LastTimeShot + DelayBetweenShots * 1 / SkillSocket.Instance.globalFireRate * 1/SkillSocket.Instance.lFireRate < Time.time)
                {
                    HandleShoot();
                    m_CurrentAmmo -= 1f;
            ...
            {
                if (m_CurrentAmmo >= 1f
                && m_LastTimeShot + DelayBetweenShots * 1 / SkillSocket.Instance.globalFireRate * 1 / SkillSocket.Instance.sGFireRate < Time.time)
                {
                    HandleShoot();
                    m_CurrentAmmo -= 1f;
            ...
            {
                if (m_CurrentAmmo >= 1f
                && m_LastTimeShot + DelayBetweenShots * 1 / SkillSocket.Instance.globalFireRate < Time.time)
                {
                    HandleShoot();
                    m_CurrentAmmo -= 1f;
