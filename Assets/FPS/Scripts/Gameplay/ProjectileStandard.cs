...
namespace Unity.FPS.Gameplay
{
    public class ProjectileStandard : ProjectileBase
    {
        ...
        new void OnShoot()
        {
            if(gameObject.name == "Projectile_Blaster(Clone)")
            {
                Damage *= SkillSocket.Instance.hGDamage;
            }else if (gameObject.name == "Projectile_Disc(Clone)")
            {
                //Damage *= testSocket.Instance.lDamage;
            }else if (gameObject.name == "Projectile_Shotgun(Clone)")
            {
                Damage *= SkillSocket.Instance.sGDamage;
            }
