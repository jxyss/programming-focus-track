...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                // Fall damage
                float fallSpeed = -Mathf.Min(CharacterVelocity.y, m_LatestImpactSpeed.y) * 1/SkillSocket.Instance.jumpHeight;
        ...
        void HandleCharacterMovement()
        {
            ...
            bool isSprinting = m_InputHandler.GetSprintInputHeld();
            {
                ...
                float speedModifier = isSprinting ? SprintSpeedModifier * SkillSocket.Instance.moveSpeed : SkillSocket.Instance.moveSpeed;
                ...
                if (IsGrounded)
                {
                    ...
                    if (IsGrounded && m_InputHandler.GetJumpInputDown())
                    {
                        ...
                        if (SetCrouchingState(false, false))
                        {
                            ...
                            CharacterVelocity += Vector3.up * JumpForce * SkillSocket.Instance.jumpHeight;
